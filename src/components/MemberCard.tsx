  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#334155] relative overflow-x-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-screen overflow-hidden pointer-events-none">
        <div 
          className="absolute top-[-10%] left-[-5%] w-[400px] h-[400px] rounded-full bg-gradient-to-br from-[#f59e0b] via-[#d97706] to-[#b45309] opacity-15 blur-3xl transition-all duration-300"
          style={{ transform: `translate(${scrollY * 0.2}px, ${scrollY * 0.3}px)` }}
        ></div>
        <div 
          className="absolute bottom-[-15%] right-[-10%] w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[#8b5cf6] via-[#7c3aed] to-[#6d28d9] opacity-20 blur-3xl transition-all duration-300"
          style={{ transform: `translate(${-scrollY * 0.15}px, ${-scrollY * 0.25}px)` }}
        ></div>
        <div 
          className="absolute top-[40%] right-[20%] w-[300px] h-[300px] rounded-full bg-gradient-to-br from-[#ec4899] via-[#db2777] to-[#be185d] opacity-15 blur-3xl transition-all duration-300"
            ...
            >
              <defs>
                ...
                <pattern id="cardBg" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
                  ...
                  <image className="fillLight" opacity="0.5" width="100" height="100" xlinkHref="data:image/svg+xml,%3Csvg width='100' height='100' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence baseFrequency='0.7' numOctaves='3'/%3E%3C/filter%3E%3Crect width='100' height='100' filter='url(%23n)' opacity='0.4'/%3E%3C/svg%3E" />
                </pattern>
              ...
              <g className="main" transform="translate(180, 180)">
                <circle className="ball bg" fill="url(#grad2)" cx="120" cy="130" r="130" opacity="0"/>
                <circle className="ball bg" fill="url(#grad3)" cx="550" cy="410" r="210" opacity="0"/>
                
                <g className="blur" mask="url(#m)">
                  <image className="bg" x="33" y="7" width="700" height="600" xlinkHref="data:image/svg+xml,%3Csvg width='700' height='600' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='b'%3E%3CfeGaussianBlur stdDeviation='50'/%3E%3C/filter%3E%3Crect width='700' height='600' fill='%23334155' filter='url(%23b)'/%3E%3C/svg%3E" />
                </g>
                
                <g className="card" filter="url(#cardGlow)">
                  ...
                  {/* Username */}
                  <text className="nameTxt" fill="#e4e4f4" fontSize="15" fontFamily="'Arial', sans-serif" letterSpacing="2" fontWeight="500">
