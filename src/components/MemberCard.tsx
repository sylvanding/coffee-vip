...
export function MemberCard() {
  ...
  const cardScale = 1 - scrollProgress * 0.3;
  const cardOpacity = 1 - scrollProgress * 0.8;
  const cardY = scrollProgress * -100;
  const secondScreenOpacity = Math.max(0, (scrollProgress - 0.3) * 2);
  const secondScreenY = (1 - scrollProgress) * 50;

  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#334155] relative overflow-x-hidden">
      {/* Background decorative orbs - 简化版，移除滚动动画 */}
      <div className="absolute top-0 left-0 w-full h-screen overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[-5%] w-[400px] h-[400px] rounded-full bg-gradient-to-br from-[#f59e0b] via-[#d97706] to-[#b45309] opacity-15 blur-3xl"></div>
        <div className="absolute bottom-[-15%] right-[-10%] w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[#8b5cf6] via-[#7c3aed] to-[#6d28d9] opacity-20 blur-3xl"></div>
        <div className="absolute top-[40%] right-[20%] w-[300px] h-[300px] rounded-full bg-gradient-to-br from-[#ec4899] via-[#db2777] to-[#be185d] opacity-15 blur-3xl"></div>
      </div>

      {/* First screen - Card display */}
      <div 
        ref={firstScreenRef}
        className="h-screen flex items-center justify-center px-4 relative transition-all duration-300"
        style={{
        ...
        <div className="w-full max-w-2xl">
          ...
          >
            <svg 
              ...
              className="drop-shadow-[0_40px_80px_rgba(0,0,0,0.6)] transition-transform duration-700"
              style={{ 
                maxWidth: '650px', 
                margin: '0 auto',
            ...
            >
              <defs>
                ...
                <linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="85%">
                  ...
                  <stop offset="110%" stopColor="#d97706" />
                </linearGradient>
                <linearGradient id="grad3" x1="0%" y1="0%" x2="100%" y2="85%">
                  <stop offset="0%" stopColor="#a78bfa" />
                  <stop offset="80%" stopColor="#8b5cf6" />
                  <stop offset="110%" stopColor="#7c3aed" />
                </linearGradient>
                <linearGradient id="grad4" x1="0%" y1="0%" x2="80%" y2="70%">
                  <stop offset="0%" stopColor="rgba(255,255,255,0.95)" />
                  <stop offset="90%" stopColor="rgba(255,255,255,0.6)" />
                </linearGradient>
                
                <pattern id="cardBg" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
                  <image opacity="0.5" width="100" height="100" xlinkHref="data:image/svg+xml,%3Csvg width='100' height='100' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence baseFrequency='0.9' numOctaves='4'/%3E%3C/filter%3E%3Crect width='100' height='100' filter='url(%23n)' opacity='0.3'/%3E%3C/svg%3E" />
                  <image opacity="0.4" width="100" height="100" xlinkHref="data:image/svg+xml,%3Csvg width='100' height='100' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence baseFrequency='0.7' numOctaves='3'/%3E%3C/filter%3E%3Crect width='100' height='100' filter='url(%23n)' opacity='0.4'/%3E%3C/svg%3E" />
                </pattern>
                
                <mask id="m">
                  <rect fill="#fff" width="340" height="540" rx="30" ry="30" />
                </mask>
          ...
          >
            <p className="text-white/70 text-base mb-2 tracking-wide font-medium">Scroll down</p>
            <svg className="w-7 h-7 mx-auto text-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Second screen - Edit functionality */}
      <div 
        ref={secondScreenRef}
        className="min-h-screen flex items-center justify-center px-4 py-20 relative"
        style={{
          transform: `translateY(${secondScreenY}px)`,
          opacity: secondScreenOpacity
        }}
      >
        <div className="w-full max-w-md space-y-6">
          {/* Edit name area */}
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-500 hover:scale-[1.02]">
            ...
            <div className="space-y-5">
              <div>
                <label className="text-sm text-gray-300 mb-3 block font-medium tracking-wide">Name</label>
                {isEditing ? (
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="flex-1 bg-white/95 border-2 border-white/40 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#f59e0b] focus:border-transparent text-gray-900 placeholder-gray-400 font-medium shadow-lg"
                    ...
                    <button
                      onClick={handleSave}
                      disabled={saving}
                      className="p-3 bg-gradient-to-br from-[#f59e0b] to-[#d97706] text-white hover:from-[#ea9c08] hover:to-[#c77205] rounded-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-105"
                      title="Save"
                    >
                    ...
                    <button
                      ...
                      disabled={saving}
                      className="p-3 bg-white/20 hover:bg-white/30 text-white rounded-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                      title="Cancel"
                    >
                      <X className="w-5 h-5" />
                    </button>
                  ...
                  <div className="flex items-center justify-between bg-white/10 rounded-xl px-5 py-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
                    <p className="text-xl font-medium text-white tracking-wide">{profile.username}</p>
                    <button
                      onClick={() => setIsEditing(true)}
                      className="p-2.5 bg-gradient-to-br from-[#f59e0b] to-[#d97706] hover:from-[#ea9c08] hover:to-[#c77205] rounded-lg transition-all duration-300 text-white shadow-md hover:shadow-lg transform hover:scale-105"
                      title="Edit"
                    >
          ...
          <button
            ...
            className="w-full bg-white/10 backdrop-blur-xl text-white py-4 rounded-2xl font-medium hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all duration-500 shadow-xl hover:shadow-2xl flex items-center justify-center gap-3 border border-white/20 group hover:scale-[1.02]"
          >
            <LogOut className="w-5 h-5 group-hover:translate-x-[-4px] transition-transform duration-300" />
